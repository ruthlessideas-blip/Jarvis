...
| Panel | What it does |
|-------|--------------|
| **Ruthless Ideas layer** 🏴 | The dashboard knows your empire: a **Ruthless Ideas** panel shows Boston / The Press / Refind / Jimpa / RIAIC with live status and pins your locked priority (first paying Boston customer → 20 DMs). One tap **Draft Boston DMs** and JARVIS writes them in *your* voice. The AI has your products, priorities, bio, and voice baked into its brain. |
| **Patricia bridge** 🔗 | If Patricia is running on `localhost:3141`, JARVIS becomes her cockpit — pulls her 5 AM briefing and task nudges into the dashboard and can push tasks back, exactly like the HQ / Office HQ bridges. Additive only; her code is never touched. Falls back cleanly to "offline" when she isn't running. |
